...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Find and book appointments with qualified doctors. Trusted healthcare at your fingertips." },
      { property: "og:title", content: "MediCare — Book trusted doctors online" },
      { property: "og:description", content: "Find and book appointments with qualified doctors." },
